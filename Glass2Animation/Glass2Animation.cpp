// Glass2Animation.cpp : Defines the entry point for the console application.
//
...
void userdraw() {
	color_t gelasColor = { 1, 0.7, 0.8 };
	color_t tutupGelasColor = { 1, 0.8, 0.8 };
	color_t tutupGelasPentulColor = { 1, 0.85, 0.8 };
	...
	//drawRectangleAnimate(p2, { 100, 200 }, tick, tutupGelasColor);
	drawRectangleAnimate(p2, { 100, 200 }, tick, tutupGelasColor);
	...
	drawRectangleAnimate(p3, { 100, 200 }, tick, tutupGelasPentulColor);
	...
	drawRectangleAnimate(p4, { 100, 0 }, tick2, tutupGelasColor);
	...
	drawRectangleAnimate(p5, { 100, 0 }, tick2, tutupGelasPentulColor);
